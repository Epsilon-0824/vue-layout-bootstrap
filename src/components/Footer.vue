        ...
        <footer class="container py-5 text-white">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                ...
                <ul class="list-unstyled d-flex">
                    <li class="ms-3">
                        <a class="text-white" href="https://www.amd.com/" aria-label="Instagram">
                            <i class="bi bi-amd"></i>
                        </a>
                    </li>
                    <li class="ms-3">
                        <a class="text-white" href="https://www.facebook.com/thanatorn.boontham.71" aria-label="Facebook">
